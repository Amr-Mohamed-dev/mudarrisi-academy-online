...
const AuthPage = () => {
    ...
    const { mutateAsync: loginMutation, isPending: isLoginLoading } = login();
    ...
    const educationalStages: string[] = [
        "أولى ابتدائي",
        "ثانية ابتدائي",
        "ثالثة ابتدائي",
        "رابعة ابتدائي",
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (userType === "student" && !educationalStage) {
            addToast({
                title: "Error",
                type: "error",
                message: "يرجى تحديد المرحلة الدراسية",
            });
            return;
        }
        ...
        const userData = {
            ...
            educationalStage:
                userType === "student" ? educationalStage : undefined,
        };
                                ...
                                >
                                    ...
                                    {userType === "teacher" && (
                                        <div className="mt-4 text-center text-sm text-amber">
                                            <p>
                                                ملاحظة: حسابات المدرسين تتطلب
                                                موافقة الإدارة قبل التفعيل
                                            </p>
                                        </div>
                                    )}
                                </form>
