        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="bg-card text-card-foreground border">
            ...
            <CardContent>
              ...
              <p className="text-gray-700 dark:text-gray-300">الرياضيات</p>
          ...
          <Card className="bg-card text-card-foreground border">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p>
                  <span className="font-bold">الوقت:</span> 10:00 صباحًا - 11:00
                  صباحًا
                </p>
                <p>
                  <span className="font-bold">المادة:</span> الرياضيات
                </p>
                <p>
                  <span className="font-bold">السعر:</span> {teacherPrice} ريال
                </p>
