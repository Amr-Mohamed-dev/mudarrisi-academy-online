            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">
                  نقدم مجموعة واسعة من المدرسين المؤهلين في مختلف المواد
                  الدراسية لتناسب احتياجاتك التعليمية.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">
                  نضمن جودة التعليم من خلال اختيار مدرسين ذوي خبرة وكفاءة عالية
                  وتقييم مستمر لأدائهم.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">
                  منصة سهلة الاستخدام تمكنك من البحث عن المدرسين وحجز الدروس
                  ومتابعة تقدمك بكل سهولة.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="space-y-8">
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      استكشف قائمة المدرسين المؤهلين وابحث حسب المادة أو المستوى
                      التعليمي أو التقييمات.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      شارك رأيك حول الدرس والمدرس لمساعدة الطلاب الآخرين في
                      اختياراتهم.
                    </p>
                  </div>
                </div>
