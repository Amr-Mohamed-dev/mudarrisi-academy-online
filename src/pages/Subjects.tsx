    ...
    const dummySubjects: Subject[] = [
      {
        id: '1',
        name: 'الرياضيات',
        description: 'تعلم أساسيات الرياضيات والجبر والهندسة وحساب التفاضل والتكامل',
        teachersCount: 24,
        level: 'جميع المراحل',
      ...
      },
      {
        ...
        teachersCount: 15,
        level: 'ثانوي وجامعي',
        categories: ['الكيمياء العضوية', 'الكيمياء غير العضوية', 'الكيمياء التحليلية']
      },
      {
        id: '5',
        name: 'اللغة العربية',
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              استكشف جميع المواد الدراسية المتوفرة وابحث عن المدرسين المناسبين لك
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-8">
            <div className="md:w-1/4">
              <div className="bg-white shadow-md rounded-lg p-4">
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 mb-2">المستوى التعليمي</label>
                ...
                <Button variant="outline" className="w-full" onClick={() => setSelectedLevel('all')}>
                  إعادة ضبط التصفية
                </Button>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredSubjects.length > 0 ? (
                  filteredSubjects.map((subject) => (
                    <Card key={subject.id} className="hover:border-blue-light hover:shadow-md transition-all">
                      ...
                      <CardContent>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {subject.categories.map((category, index) => (
                            <Badge key={index} variant="secondary" className="bg-blue-light/10 text-blue-dark">
                              {category}
                            </Badge>
                          ))}
                        </div>
                        ...
                        <div className="mt-4">
                          <Button className="w-full" asChild>
                            <Link to={`/subjects/${subject.id}`}>عرض المدرسين</Link>
                          </Button>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <div className="col-span-full text-center py-12">
                    <p className="text-xl text-gray-500">لم يتم العثور على مواد مطابقة لمعايير البحث</p>
                    <Button 
                      variant="link" 
                      onClick={() => {
                        setSearchTerm('');
