    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-b from-blue to-blue-dark text-white py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            ابحث عن أفضل المدرسين{" "}
            <span className="text-amber">لجميع المواد الدراسية</span>
          </h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            منصة المدرسين تساعدك في العثور على المدرسين المتخصصين في مختلف
            المواد وحجز مواعيد الدروس بسهولة
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-blue-dark">
            كيف تعمل المنصة
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                ابحث عن المدرسين حسب المادة أو المرحلة الدراسية
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                اطلع على تقييمات الطلاب ومؤهلات المدرسين وخبراتهم
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                اختر الوقت المناسب لك واحجز درسك الأول بسهولة
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                استمتع بالدروس واترك تقييمًا للمدرس بعد الانتهاء
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <p className="mb-4 text-gray-100">
                "وجدت مدرس الرياضيات المثالي من خلال المنصة. شرحه واضح وبسيط،
                وساعدني كثيرًا في تحسين درجاتي."
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <p className="mb-4 text-gray-100">
                "منصة رائعة وسهلة الاستخدام. حجزت عدة دروس في اللغة الإنجليزية،
                والنتائج كانت مذهلة!"
              </p>
              <div className="flex items-center">
                <div className="ml-3 h-10 w-10 rounded-full bg-blue-dark"></div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <p className="mb-4 text-gray-100">
                "كأب، أقدر حقًا جودة المدرسين على المنصة وسهولة جدولة الدروس
                لأطفالي. توفر الكثير من الوقت والجهد."
              </p>
              <div className="flex items-center">
                <div className="ml-3 h-10 w-10 rounded-full bg-blue-dark"></div>
                <div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6 text-blue-dark">
            هل أنت مستعد لبدء رحلة التعلم؟
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            انضم إلى الآلاف من الطلاب الذين يستفيدون من منصتنا للوصول إلى أفضل
            المدرسين
          </p>
