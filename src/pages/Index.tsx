            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <AnimatedSection delay={0.4}>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  اكتشف عالماً من التعلم مع مدرسين محترفين ومتخصصين في جميع المواد الدراسية.
                  احجز درسك الآن واحصل على تعليم شخصي يناسب احتياجاتك.
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.6}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button size="lg" className="bg-blue hover:bg-blue-dark text-white px-8 py-3" asChild>
                      <Link to="/teachers">
                        ابدأ التعلم الآن
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button size="lg" variant="outline" className="border-blue text-blue hover:bg-blue hover:text-white px-8 py-3" asChild>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <motion.div 
                      className="text-3xl font-bold text-blue-dark mb-2"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <AnimatedSection delay={1.5} className="text-center mb-12">
              <h2 className="text-3xl font-bold text-blue-dark mb-4">المواد المتاحة</h2>
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {subjects.map((subject, index) => (
                ...
                >
                  <Badge 
                    variant="secondary" 
                    className="bg-white hover:bg-blue-light/10 text-blue-dark border border-blue-light/20 px-4 py-2 text-sm cursor-pointer"
                  >
                    {subject}
                  </Badge>
                </motion.div>
