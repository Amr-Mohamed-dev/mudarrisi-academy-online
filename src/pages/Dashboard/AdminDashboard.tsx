...
const AdminDashboard = () => {
  // Store sidebar state in sessionStorage to persist during session
  const [sidebarOpen, setSidebarOpen] = useState(() => {
    const savedState = sessionStorage.getItem("adminSidebarOpen");
  ...
  useEffect(() => {
    sessionStorage.setItem("adminSidebarOpen", JSON.stringify(sidebarOpen));
  }, [sidebarOpen]);
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const teachers = allUsers.filter(
        (u) => u.role === ("TEACHER" as UserRole)
      );
      const students = allUsers.filter(
        (u) => u.role === ("STUDENT" as UserRole)
      );
      ...
      // إنشاء أنشطة وهمية (في التطبيق الحقيقي ستأتي من قاعدة البيانات)
      const mockActivities: Activity[] = [
        ...
        {
          user: "سارة أحمد",
          action: "أضافت تقييماً للمدرس خالد العمري",
          time: "منذ 25 دقيقة",
          image: "/placeholder.svg",
        },
        {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground mt-20">
      {/* Admin Navbar */}
      ...
      <div className="flex flex-1">
        {/* Sidebar - Using sessionStorage to persist state during session */}
        <aside
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="bg-card text-card-foreground border">
                <CardHeader>
                  <CardTitle>المواد الأكثر طلباً</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {[
              ...
              <Card className="bg-card text-card-foreground border">
                <CardHeader>
                  <CardTitle>المدرسون الممميزون</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {[
