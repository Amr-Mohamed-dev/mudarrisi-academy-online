...
const AboutPage = () => {
  ...
  return (
    <PageTransition className="flex flex-col min-h-screen bg-background text-foreground pt-10">
          ...
          <AnimatedSection delay={0.2}>
            <section className="mb-16 text-center">
              ...
              <motion.p
                ...
                المدرسين المؤهلين. نحن نؤمن بأن التعليم الجيد هو حق للجميع،
                ونسعى لتوفير تجربة تعليمية متميزة سهلة الوصول.
              </motion.p>
            </section>
          </AnimatedSection>
            ...
            <section className="mb-16">
              ...
              <motion.div
                ...
                <motion.p
                  ...
                  العالم العربي، ونسعى لتمكين كل طالب من الوصول إلى أفضل
