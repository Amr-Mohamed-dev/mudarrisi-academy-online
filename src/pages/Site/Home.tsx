                        ...
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            <AnimatedSection delay={0.4}>
                                <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                                    اكتشف عالماً من التعلم مع مدرسين محترفين
                                    ومتخصصين في جميع المواد الدراسية. احجز درسك
                                    الآن واحصل على تعليم شخصي يناسب احتياجاتك.
                                </p>
                            </AnimatedSection>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        >
                            ...
                            <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
                                نوفر دروساً في جميع المواد الدراسية مع مدرسين
                                متخصصين ومؤهلين
                            </p>
                        </AnimatedSection>
                ...
                <AnimatedSection delay={2.4}>
                    <section className="py-20 bg-gradient-to-r from-blue to-blue-dark">
                        <div className="container mx-auto px-4 text-center">
                            ...
                            >
                                انضم إلى آلاف الطلاب الذين حققوا أهدافهم
                                التعليمية معنا
                            </motion.p>
