...
const TeacherRatingsPage = () => {
    ...
    const hasRated = (bookingId: string) => {
        ...
        return ratings.some(
            (rating: any) =>
                rating.bookingId === bookingId && rating.raterRole === "teacher"
        );
    };
                ...
                <Tabs defaultValue="pending" className="w-full">
                    ...
                    <TabsContent value="pending">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {bookings.filter((booking) => !hasRated(booking.id))
                                .length > 0 ? (
                                bookings
                                    .filter((booking) => !hasRated(booking.id))
                                    .map((booking) => (
                                        <Card
                                            key={booking.id}
