...
const Navbar = () => {
    ...
    const links = [
        { href: SITE_MAP.site.home.href, label: "الرئيسية" },
        { href: SITE_MAP.site.teachers.href, label: "المدرسين" },
        { href: SITE_MAP.site.subjects.href, label: "المواد" },
        { href: SITE_MAP.site.about.href, label: "من نحن" },
    ];
                ...
                <div className="flex items-center gap-5">
                    ...
                    {user ? (
                        ...
                        >
                            ...
                            <h1 className="hidden md:block text-xl font-medium dark:text-gray-200">
                                Hi ,{user?.name || "there"}!
                            </h1>
                            {/* Dropdown profile */}
                        ...
                        <button
                            ...
                            className="hidden md:block text-gray-600 dark:text-gray-200 hover:opacity-80 rounded-lg cursor-pointer transition-all duration-300 ease-in-out"
                        >
                            تسجيل الدخول
                        </button>
                    )}
                    ...
                    <button
                        onClick={toggleMenu}
                        className="md:hidden text-gray-700 dark:text-gray-200 hover:opacity-80 transition-all"
                    >
                ...
                <div className="md:hidden flex flex-col items-center gap-4 py-4 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
                    ...
                    {!user && (
                        <button
                            ...
                            className="text-gray-700 dark:text-gray-200 hover:opacity-80 transition-all duration-300"
                        >
                            تسجيل الدخول
                        </button>
                    )}
