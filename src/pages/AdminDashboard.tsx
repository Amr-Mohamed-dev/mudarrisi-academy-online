          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <Link to="/" className="flex items-center">
                <span className="text-xl font-bold mx-2">لوحة التحكم</span>
              </Link>
            </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-[250px] flex items-center justify-center border border-dashed border-gray-300 rounded-md">
                    <p className="text-gray-500">هنا يتم عرض رسم بياني للزيارات</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { name: 'الرياضيات', percentage: 75 },
                      { name: 'اللغة الإنجليزية', percentage: 68 },
                      { name: 'الفيزياء', percentage: 52 },
                      { name: 'الكيمياء', percentage: 48 },
                      { name: 'اللغة العربية', percentage: 45 },
                    ].map((subject, i) => (
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { name: 'أحمد محمد', subject: 'الرياضيات', rating: 4.9, students: 48, image: '/placeholder.svg' },
                      { name: 'سارة علي', subject: 'اللغة الإنجليزية', rating: 4.8, students: 42, image: '/placeholder.svg' },
                      { name: 'محمد خالد', subject: 'الفيزياء', rating: 4.8, students: 35, image: '/placeholder.svg' },
                      { name: 'نورة عبدالله', subject: 'الكيمياء', rating: 4.7, students: 31, image: '/placeholder.svg' },
                    ].map((teacher, i) => (
                      <div key={i} className="flex items-center justify-between">
                        ...
                        <div className="text-left">
                          <div className="flex items-center">
                            <p className="font-medium ml-1">{teacher.rating}</p>
                            <svg className="h-4 w-4 fill-amber" viewBox="0 0 24 24">
                              <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                            </svg>
                          </div>
                          <p className="text-xs text-gray-500">{teacher.students} طالب</p>
                        </div>
                      </div>
                    ))}
                  </div>
