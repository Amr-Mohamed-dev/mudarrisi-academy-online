        ...
        <div className="flex justify-between items-center h-16">
          ...
          {!isMobile && (
            <div className="relative mx-4 flex-1 max-w-md justify-between items-center ">
              <div className="absolute inset-y-0 left-0 flex items-center pr-3 pointer-events-none text-gray-400">
                <Search className="h-4 w-4" />
              </div>
              <input
                type="text"
                placeholder="ابحث عن مدرس أو مادة..."
                className="w-full py-2 px-10 pl-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue"
              />
            </div>
          )}
          ...
          {!isMobile && (
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <Link
                to="/teachers"
                className="text-gray-700 hover:text-blue px-3 py-2">
                المدرسين
              </Link>
              <Link
                to="/subjects"
                ...
                <div className="flex items-center space-x-4 space-x-reverse mr-4">
                  ...
                  <Link
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="rounded-full bg-blue/10">
          ...
          {isMenuOpen && (
            <div className="px-4 py-6 space-y-4 animate-fade-in">
              ...
              <div className="flex flex-col space-y-2">
                <Link
                  to="/"
                  className="text-gray-700 hover:text-blue px-3 py-2 border-b">
                  الرئيسية
                </Link>
                <Link
                  to="/teachers"
